...
public class ABUtil {
	...
	public static boolean isAngularSupport (ERA relations) {
		if (StabilityRules.CheckRule(relations, 31))
			return true;
		return false;
	}
	...
	// Return a list of Angular supporters
	public static List<ABObject> getAngularSupporters() {
		List<ABObject> result = new LinkedList<ABObject>();
